...
La documentazione dettagliata del codice deve essere inoltre considerata parte integrante del progetto software, senza la quale sono seriamente compromesse le caratteristiche di correttezza ed manutenibilità della procedura. È fortemente auspicato un approccio alla documentazione _in linea_, dove i singoli moduli software vengono realizzati direttamente insieme alla relativa documentazione, contestualizzate nello stesso frammento di codice. Ciò anche al fine di abilitare metodologie automatizzate di produzione della documentazione (per es. JavaDoc) e sistemi automatici di rilevazione di errori o obsolescenza nella documentazione.
...
La stessa applicazione deve rendere disponibili, con discrezione ma contestualmente ai controlli di interfaccia grafica, scorciatoie verso la manualistica in formato digitale, consultabili dagli utenti su necessità.
